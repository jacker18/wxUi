...
<template>
  ...
  <div id="scene" class="stars-wrapper">
    ...
    <div data-depth="0.40" class="title-wrapper layer">
      <h1 data-title="欢迎来到我的世界" class="title">欢迎来到我的世界</h1>
    </div>
  </div>
  </div>
</template>
...
<script>
 ...
 import $ from "jquery";
 import "../assets/js/jquery.parallax";
import loginIn from "../module/login";
 export default {
  name: 'HelloWorld',
  data () {
    return {
      msg: 'Welcome to Your Vue.js App'
        ...
        // parallax($);
         window.onresize=function(){
             ...
             $(".stars-wrapper").css({width:Wid+"px",height:Hei+"px"});
             console.log(Wid,Hei)
         }
